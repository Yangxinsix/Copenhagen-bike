...
#        prediction = prediction[:,scale_indices]
        ...
        prediction = get_rider_box(prediction, 0.1)     
...
#        print(end - start)
    ...
    def write(x, batches, results):
        ...
        print('Bounding boxes: left={}, top={}, right={}, bottom={}'.format(c1[0], c1[1], c2[0], c2[1]))
